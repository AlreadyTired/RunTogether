...
public class SensorListViewRequest extends StringRequest {
    final static private String URL = serverURL + SensorListViewURL;                          // URL 헤더파일로 묶어서 수정해야함.
    ...
    public SensorListViewRequest(Response.Listener<String> listener, final Context context)
    {
