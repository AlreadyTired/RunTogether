...
public class SensorDeregistrationRequest extends StringRequest {
    final static private String URL = serverURL + SensorDeregistrationURL;                          // URL 헤더파일로 묶어서 수정해야함.
    ...
    public SensorDeregistrationRequest(String MacAddress,Response.Listener<String> listener, final Context context)
    {
