...
public class SpecificUserDataRequest extends StringRequest {
    final static private String URL = serverURL + SpecificUserRealTimeDataURL;                          // URL 헤더파일로 묶어서 수정해야함.
    ...
    public SpecificUserDataRequest(String email,Response.Listener<String> listener, final Context context)
    {
