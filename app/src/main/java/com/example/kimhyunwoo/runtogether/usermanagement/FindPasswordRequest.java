...
public class FindPasswordRequest extends StringRequest {
    final static private String URL = serverURL + findpasswordURL;                          // URL 헤더파일로 묶어서 수정해야함.
    ...
    public FindPasswordRequest(String userEmail, Response.Listener<String> listener, final Context context)
    {
