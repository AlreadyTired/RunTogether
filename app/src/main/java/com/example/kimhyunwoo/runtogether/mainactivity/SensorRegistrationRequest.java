...
public class SensorRegistrationRequest extends StringRequest {
    final static private String URL = serverURL + SensorRegistrationURL;                          // URL 헤더파일로 묶어서 수정해야함.
    ...
    public SensorRegistrationRequest(String MacAddress, String DeviceName, Response.Listener<String> listener, final Context context)
    {
