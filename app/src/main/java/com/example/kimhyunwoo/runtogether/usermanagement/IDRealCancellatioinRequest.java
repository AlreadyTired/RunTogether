...
public class IDRealCancellatioinRequest extends StringRequest
{
    final static private String URL = serverURL + idrealcancellationURL;                          // URL 헤더파일로 묶어서 수정해야함.
    ...
    public IDRealCancellatioinRequest(Response.Listener<String> listener, final Context context)
    {
